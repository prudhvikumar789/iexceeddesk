...
external_url 'http://192.168.1.60:6066/'
...
###! install
  gitlab_rails['mattermost_host'] = "http://localhost:6066/"
...
###! **remember to close this block with 'EOS' below**
  gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
   main: # 'main' is the GitLab 'provider ID' of this LDAP server
     ...
     port: 389
     uid: 'sAMAccountName'
     bind_dn: 'CN=prudhvi kumar,OU=Product,DC=i-exceed,DC=com'
     password: 'Vijayraja@123'
...
###! **Use smtp instead of sendmail/postfix.**
  ...
  gitlab_rails['smtp_user_name'] = "prudhvi.kumar@i-exceed.com"
  gitlab_rails['smtp_password'] = "Prabhakar@123"
  gitlab_rails['smtp_domain'] = "i-exceed.com"
...
###! Docs: http://api.rubyonrails.org/classes/ActionMailer/Base.html
 ...
 gitlab_rails['gitlab_email_from'] = 'prudhvi.kumar@i-exceed.com'
 gitlab_rails['gitlab_email_reply_to'] = 'prudhvi.kumar@i-exceed.com'
...
# postgresql['autovacuum_vacuum_cost_delmattermost.iexceed.comay'] = "20ms"
...
# mattermost['username'] = 'mattermost'ss
...
'MM_SERVICESETTINGS_ENABLEAPIV3' => 'true',
...
'MM_EMAILSETTINGS_SMTPUSERNAME' => 'prudhvi.kumar@i-exceed.com',
'MM_EMAILSETTINGS_SMTPPASSWORD' => 'Prabhakar@123',
...
'MM_EMAILSETTINGS_FEEDBACKEMAIL' => 'prudhvi.kumar@i-exceed.com',
'MM_EMAILSETTINGS_SENDPUSHNOTIFICATIONS' => 'true',
'MM_EMAILSETTINGS_ENABLEBATCHING' => 'true',
'MM_EMAILSETTINGS_SMTPAUTH' => 'true',
...
# mattermost['service_enable_insecure_outgoing_connections'] = false
  mattermost['service_allowed_untrusted_internal_connections'] = "http://192.168.1.60:6066/"
...
# mattermost['service_user_access_tokens'] = true
...
mattermost['gitlab_id'] = "ec5e7af0c1d74c9d2d910e2bd4aff8807bc3fc468002e98ee9333400206a45dd"
mattermost['gitlab_secret'] = "e3cf0e8271fd72f4aa30a0f986b341ef4fa764c8762675efca1d3e8feb425dff"
mattermost['gitlab_scope'] = ""
mattermost['gitlab_auth_endpoint'] = "http://192.168.1.60:6066/oauth/authorize"
mattermost['gitlab_token_endpoint'] = "http://192.168.1.60:6066/oauth/token"
mattermost['gitlab_user_api_endpoint'] = "http://192.168.1.60:6066/api/v4/user"
...
# mattermost['email_smtp_username'] = "prudhvi.kumar@i-exceed.com"
# mattermost['email_smtp_password'] = "Prabhakar@123"
...
# mattermost['email_feedback_email'] = "prudhvi.kumar@i-exceed.com"
